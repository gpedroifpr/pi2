// script.js (VERSÃO FINAL E COMPLETA - SUBSTITUA TUDO)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const createVitrineForm = document.getElementById('create-vitrine-form');
    ...
    vitrineSelect.addEventListener('change', (e) => fetchProductsForAdmin(e.target.value));
    ...
    createVitrineForm.addEventListener('submit', async (e) => {
        e.preventDefault();
